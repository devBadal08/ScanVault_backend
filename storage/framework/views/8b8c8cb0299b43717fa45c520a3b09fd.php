...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-10 h-10 mb-3 text-gray-700']); ?>
...
<?php endif; ?>
                            <span class="text-xl font-semibold"><?php echo e($company->company_name); ?></span>
                        </div>
                    </div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-10 h-10 mb-3 text-gray-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            <span class="text-xl font-semibold text-gray-600"><?php echo e($company->company_name); ?></span>
        ...
        <div class="space-y-3">
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getSubCompanies(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="flex items-center gap-3">
                    <input type="checkbox" wire:model="selectedSubCompanies" value="<?php echo e($sub->id); ?>">
        ...
        <div class="mt-8">
            ...
            <ul class="list-disc ml-6 space-y-1">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getAssignedSubCompanies(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assigned): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="text-gray-700 text-md"><?php echo e($assigned->company_name); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </ul>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ScanVault_backend-main\resources\views/filament/admin/pages/company-hierarchy-access.blade.php ENDPATH**/ ?>
...
>
    <button
        ...
        :class="theme ? 'text-gray-700 dark:text-white' : 'text-gray-400 dark:text-gray-600 hover:text-gray-500 focus:text-gray-500 dark:hover:text-gray-500 dark:focus:text-gray-500'"
        @click="menu = ! menu"
    >
...
<?php /**PATH C:\xampp\htdocs\ScanVault_backend-main\vendor\laravel\framework\src\Illuminate\Foundation\Providers/../resources/exceptions/renderer/components/theme-switcher.blade.php ENDPATH**/ ?>
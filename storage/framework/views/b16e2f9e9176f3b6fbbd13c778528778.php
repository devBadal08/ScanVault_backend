...
<?php $component->withAttributes([]); ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(\App\Filament\Admin\Resources\CompanyResource::getUrl('dashboard', ['record' => $company->id])); ?>" class="block">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.card','data' => ['class' => 'cursor-pointer hover:bg-gray-50 transition duration-200 ease-in-out']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'cursor-pointer hover:bg-gray-50 transition duration-200 ease-in-out']); ?>
                    <h2 class="text-xl font-bold mb-2 text-gray-900"><?php echo e($company->company_name); ?></h2>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ScanVault_backend-main\resources\views/filament/admin/resources/company-resource/pages/company-list.blade.php ENDPATH**/ ?>
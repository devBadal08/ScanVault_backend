...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:click' => 'goBack','color' => 'primary','class' => 'absolute left-0 inline-flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'goBack','color' => 'primary','class' => 'absolute left-0 inline-flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300 transition']); ?>
                ← Back
...
<?php endif; ?>
    ...
    <?php else: ?>
        <h1 class="text-2xl font-bold mb-4"><?php echo e($company->company_name); ?> Dashboard</h1>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ScanVault_backend-main\resources\views/filament/admin/resources/company-resource/pages/company-dashboard.blade.php ENDPATH**/ ?>
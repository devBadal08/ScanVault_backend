...
<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <!--[if BLOCK]><![endif]--><?php if(is_null($remainingLimit) || $remainingLimit > 0): ?>
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
...
<?php endif; ?>
            <?php else: ?>
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','disabled' => true,'title' => 'You have reached your maximum user creation limit.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','disabled' => true,'title' => 'You have reached your maximum user creation limit.']); ?>
                    New User
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!is_null($remainingLimit)): ?>
            <div class="mb-4
                <?php echo e($remainingLimit <= 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'); ?>">
                You have created <?php echo e($totalUsers); ?> of your <?php echo e(auth()->user()->max_limit); ?> allowed users and managers.
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ScanVault_backend-main\resources\views/filament/admin/pages/create-or-edit-user.blade.php ENDPATH**/ ?>
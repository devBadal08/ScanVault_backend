...
<?php endif; ?>
                        ...
                        <a href="?manager=<?php echo e($selectedManager->id); ?>&user=<?php echo e($selectedUser->id); ?>&folder=<?php echo e($folder['name']); ?>"
...
<?php endif; ?>
                            ...
                            <span class="mt-1 text-sm text-black truncate w-24" title="<?php echo e(basename($folder['name'])); ?>">
                                <?php echo e(Str::limit(basename($folder['name']), 20)); ?>

                            </span>
                            <span class="text-xs text-gray-500 mt-1">Created: <?php echo e($folder['created_at']); ?></span>
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </div>
            ...
            <div class="grid gap-2" style="grid-template-columns: repeat(auto-fill, minmax(8rem, 1fr));">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $subfolders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subfolder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative w-32 h-32 bg-white rounded shadow border hover:bg-orange-100 text-center text-xs font-medium">
                        ...
                        <a href="<?php echo e(route('download-folder', ['path' => $subfolder['name']])); ?>"
...
<?php endif; ?>
                        ...
                        <a href="?manager=<?php echo e($selectedManager->id); ?>&user=<?php echo e($selectedUser->id); ?>&folder=<?php echo e($selectedFolder); ?>&subfolder=<?php echo e($subfolder['name']); ?>"
                        class="absolute inset-0 flex flex-col items-center justify-center px-2">
                            ...
                            <div class="text-xs text-gray-500 mt-1">Created: <?php echo e($subfolder['created_at']); ?></div>
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => '?manager='.e($selectedManager->id).'&user='.e($selectedUser->id).'&folder='.e($selectedFolder).'','color' => 'primary','icon' => 'heroicon-o-arrow-left']); ?>
                    Back to <?php echo e(basename($selectedFolder)); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!empty($subfolders)): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $subfolders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative w-32 h-32 bg-white rounded shadow border hover:bg-orange-100 text-center text-xs font-medium">
                            ...
                            <a href="<?php echo e(route('download-folder')); ?>?path=<?php echo e(urlencode($sf['name'])); ?>"
...
<?php endif; ?>
                            ...
                            <a href="?manager=<?php echo e($selectedManager->id); ?>&user=<?php echo e($selectedUser->id); ?>&folder=<?php echo e($selectedFolder); ?>&subfolder=<?php echo e($sf['name']); ?>"
                                class="absolute inset-0 flex flex-col items-center justify-center px-2">
                                📁
                                ...
                                <div class="text-xs text-gray-500 mt-1">Created: <?php echo e($sf['created_at']); ?></div>
                            </a>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
